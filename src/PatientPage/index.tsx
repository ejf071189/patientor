...
const PatientPage = () => {
  ...
  if ( !id || !patients[id] || !patients[id].entries || Object.keys(diagnoses).length === 0  ) return null;
  ...
  return (
    ...
    <div className="App">
      ...
      <Button variant="contained" style={{ marginTop: 15 }} onClick={() => openModal()}>
        Add New Entry
      </Button>
    </div>
  );
